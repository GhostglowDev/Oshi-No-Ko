--[[
    I actually got this from the Psych Engine server shishishishi
    - Ghost
]]

focusdad = false;

function onStepHit() -- No trails on the pixel stage thingy
	if songName == "Perseverance" then
